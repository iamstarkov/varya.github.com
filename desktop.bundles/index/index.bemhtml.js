...
match(function() { return !this.elem }, function() { return this.block === "link" }, function() { return this._mode === "attrs" })(function() {{var _$qctx = this.ctx,_$qprops = ["title","target"],_$qp = typeof _$qctx.url,_$qa = {"href": (((_$qp === "undefined" || _$qp === "string")?_$qctx.url:((_$qp = [] , local({ "_buf": (_$qp), "_mode": (""), "ctx": (_$qctx.url) })(function() { return apply()}) , _$qp.join("")))))};while(_$qp = _$qprops.pop()){_$qctx[_$qp] && ((_$qa[_$qp] = _$qctx[_$qp]))};return _$qa}})
...
match(function() { return !this.elem }, function() { return this.block === "page" }, function() { return this["__$anflg4"] !== true }, function() { return this._mode === "default" })(function() {{var _$14ctx = this.ctx,_$14dtype = local({ "_mode": ("doctype") })(function() { return apply()}),_$14xUA = local({ "_mode": ("xUACompatible") })(function() { return apply()}),_$14buf = [_$14dtype,{"elem": "root","content": [{"elem": "head","content": [{"tag": "meta","attrs": {"charset": "utf-8"}},_$14xUA,{"tag": "title","content": _$14ctx.title},(_$14ctx.favicon?{"elem": "favicon","url": _$14ctx.favicon}:""),_$14ctx.meta,{"block": "i-ua"},_$14ctx.head]},_$14ctx]}];local({ "__$anflg4": (true) })(function() { local({ "ctx": (_$14buf), "_mode": ("") })(function() { apply()});});;undefined}});
